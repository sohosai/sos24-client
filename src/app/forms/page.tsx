...
const DashboardPage: NextPage = () => {
  ...
  const { data: formsRes } = useSWR(
    `/forms?project_id=${projectId}`,
    fetcherWithToken,
  );
  ...
  const answers = answersRes
    ? assignType("/form-answers", answersRes)
    : undefined;
  ...
  return (
    <>
      ...
      >
        ...
        >
          {(projectRes && !projectRes.ok) || (formsRes && !formsRes?.ok) ||
            ...
            ? (
              <p>
                ...
                {(projectRes && !projectRes?.ok
                  ...
                  : "") +
                  (formsRes && !formsRes?.ok
                    ? `Forms: ${formsRes?.statusCode} `
                    : "") +
                  (answersRes && !answersRes?.ok
