...
type FormAnswerListProps = { answers: components["schemas"]["FormAnswerSummary"][]; deadline: string };

export const FormAnswerList: React.FC<FormAnswerListProps> = ({ answers, deadline }) => {
  return (
    <>
            ...
            return (
              <Link
                ...
                <div className={hstack({ gap: 5 })}>
                  <span data-testid="answered_at">{dayjs(answer.updated_at).format("MM/DD HH:mm")}</span>
                  <span className={css({ fontWeight: "bold" })} data-testid="project_title">
                    {answer.project_title}
                  </span>
                </div>
