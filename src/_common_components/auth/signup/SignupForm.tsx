...
import { basicErrorMessageStyle, basicFormStyle, checkboxFormStyle } from "@/_common_components/forms/styles";
...
export const SignupForm = () => {
  ...
  return (
    <form
      ...
      <Button color="tsukuba.purple" className={css({ alignSelf: "center" })} type="submit">
        送信
      </Button>
    </form>
  );
